  ...
  return (
    <div className='w-full h-screen overflow-hidden'>
      <div
        data-scroll
        data-scroll-speed='-.7'
        className='h-full w-full relative bg-cover bg-center bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg")]'
      >
          ...
          <div className='bg-white h-[15vw] flex items-center justify-center w-[15vw] rounded-full'>
            <div className='bg-black flex items-center justify-center h-2/3 relative w-2/3 rounded-full'>
              ...
              <div
                ...
                className='w-full h-10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'
              >
                <div className='bg-white h-4 w-4 rounded-full'></div>
              </div>
            </div>
          </div>
          <div className='bg-white h-[15vw] w-[15vw] flex items-center justify-center rounded-full'>
